...
[입력]
- 사용자 로또 구매
  - 돈 입력 받기 : 개수 = 입력값/1000 처리
    **1000원으로 나누어지지 않으면 에러처리**
  - 로또 입력 받기 : 번호 & 보너스 번호 입력 받기
      **에러 처리 : [ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다.**

[도메인로직]
- 로또 정답
  - 로또 숫자 랜덤 생성(6개 & 보너스숫자 -- lotto 클래스 보고 수정 체크) 
    - 숫자 범위 1~45
    - 중복 없음
    - 오름차순으로 정렬
