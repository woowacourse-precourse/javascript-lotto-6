...
- [x] 구입 금액에 해당하는 만큼 로또 티켓을 발행한다.

  - [x] 1부터 45까지의 중복되지 않는 숫자 6개를 생성한다.
  - [x] 발행한 로또 수량 및 번호를 출력한다. (번호는 오름차순)

- [x] 플레이어에게 당첨 번호와 보너스 번호를 입력받는다.

  - [x] 로또 번호는 쉼표(,)를 기준으로 구분한다.

- [x] 발행한 로또 티켓의 번호와 플레이어의 당첨 번호를 비교한다.

  - [x] 당첨 내역을 출력한다.
  - [x] 수익률을 출력한다. (소수점 둘째 자리에서 반올림)

- [x] 예외 발생 -> 에러 메세지 출력하고 다시 입력 받는다.
  - [x] 로또 구입금액을 제대로 입력하지 않은 경우
    - [x] 1,000원으로 나누어 떨어지지 않는 경우
    - [x] 숫자가 아닌 경우
    - [x] 입력하지 않은 경우
  - [x] 당첨 번호를 제대로 입력하지 않은 경우
    - [x] 6개가 아닌 경우
    - [x] 중복된 경우
    - [x] 입력하지 않은 경우
    - [x] 숫자가 아닌 것을 포함한 경우
  - [x] 보너스 번호를 제대로 입력하지 않은 경우
    - [x] 입력하지 않은 경우
    - [x] 숫자가 아닌 것을 포함한 경우
