...
[] 1천원 단위로 입력 가능
[] 1천원 이하인 경우 예외처리
[] 1천원 이상이지만 1천원으로 나누어 떨어지지 않을 경우 예외처리
[] 문자 입력 시 예외처리
[] 예외처리는 재입력으로 안내

2. 로또 번호 발행
[] 1~45 숫자 중 랜덤으로 중복되지 않은 6개의 숫자 출력
[] 로또 구입개수 출력
[] 오름차순으로 정렬
...
4. 보너스 번호 입력
[] 보너스 번호의 숫자 역시 1~45 숫자 랜덤으로 추출하나 당첨번호와 중복되지 않는 번호로 추출

5. 당첨 통계 출력
[] 미션에서 제시된 통계 방식(1~5등)으로 출력
