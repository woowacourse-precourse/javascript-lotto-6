...
- ### 로또 구입 금액 입력 받기
  ...
  - [x] _(예외)_ 숫자 이외의 문자를 입력하면 예외
  - [x] _(예외)_ 금액이 1000원으로 나누어 떨어지지 않으면 예외
  - [x] _(예외)_ 아무것도 입력하지 않으면 예외

- ### 발행한 로또 수량 및 번호 출력하기

  - [x] "N개를 구매했습니다." 문구 출력
  - [x] 각 로또마다 랜덤한 숫자 6개를 오름차순으로 출력
...
- ### 당첨 번호 입력 받기
  ...
  - [x] _(예외)_ 숫자 이외의 문자를 입력하면 예외
  - [x] _(예외)_ 정확히 6개의 숫자를 입력하지 않으면 예외
  - [x] _(예외)_ 6개의 숫자가 1~45 범위에 해당하지 않으면 예외
  - [x] _(예외)_ 6개의 숫자 중 중복되는 것이 있으면 예외

- ### 보너스 번호 입력 받기

  - [x] "보너스 번호를 입력해 주세요." 문구 출력
  - [x] _(예외)_ 숫자 이외의 문자를 입력하면 예외
  - [x] _(예외)_ 입력한 숫자가 1~45 범위에 해당하지 않으면 예외
  - [x] _(예외)_ 당첨 번호에 있는 숫자를 입력하면 예외

- ### 당첨 통계 출력하기
  - [x] "당첨 통계\n---" 문구 출력
  - [x] 3개 일치부터 6개 일치까지 각 경우에 해당하는 로또 개수 구해서 출력
  - [x] 구입금액과 당첨금액을 비교해서 수익률 출력(구입금액이 100.0%에 해당)
