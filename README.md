...
- [ ] 구입 금액에 해당하는 만큼 로또 티켓을 발행한다.

  - [ ] 1부터 45까지의 중복되지 않는 숫자 6개와 보너스 번호 1개를 생성한다.
  - [ ] 발행한 로또 수량 및 번호를 출력한다. (번호는 오름차순)

- [ ] 플레이어에게 당첨 번호와 보너스 번호를 입력받는다.

  - [ ] 로또 번호는 쉼표(,)를 기준으로 구분한다.

- [ ] 발행한 로또 티켓의 번호와 플레이어의 당첨 번호를 비교한다.

  - [ ] 당첨 내역을 출력한다.
  - [ ] 수익률을 출력한다. (소수점 둘째 자리에서 반올림)

- [ ] 예외 발생 -> 에러 메세지 출력하고 다시 입력 받는다.
  - [ ] 로또 구입금액을 제대로 입력하지 않은 경우
