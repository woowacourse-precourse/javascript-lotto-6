...
- [ ] 로또 번호가 유효하지 않을 경우 예외가 발생해야 한다.
- [ ] 로또 번호를 외부에 전달할 때 메시지 형태로 전달해야 한다.
- [ ] 로또 당첨 번호, 보너스 번호가 주어진 경우 등수 판단을 할 수 있어야 한다.

### LottoStore

- [ ] 로또 구매 수량이 유요하지 않을 경우 예외가 발생해야 한다.
- [ ] 로또 구매 수량 만큼 로또를 생성해야 한다

### LottoResult

- [ ] 로또 당첨 결과의 초기 상태는 모두 0이어야 한다.
...
- [ ] 로또 당첨 결과는 외부에서 변경할 수 없어야 한다.
- [ ] 로또 당첨 번호, 보너스 번호가 주어지면 로또 당첨 결과를 업데이트해야 한다.
- [ ] 로또 당첨 결과, 로또 구매 수량이 주어지면 로또 수익률을 계산할 수 있어야 한다.
