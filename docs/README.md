...
- 로또 게임은 [🚀 기능 요구 사항](#🚀-기능-요구-사항)을 만족해야 한다.

## 🛠️ 구현 기능 목록

- [ ] Person - 로또 구입 금액 입력받기
- [ ] Person - 로또 구입 금액 유효성 검사

- [ ] Lotto - 랜덤한 6개의 로또 번호 선정하기

- [ ] WinningLotto - 당첨 번호 입력받기
- [ ] WinningLotto - 당첨 번호 유효성 검사
- [ ] WinningLotto - 보너스 번호 입력받기
- [ ] WinningLotto - 보너스 번호 유효성 검사

- [ ] 당첨번호와 각 로또의 일치 갯수 계산
- [ ] 일치 갯수를 통한 등수 및 수익금 계산
- [ ] 당첨 통계 출력
