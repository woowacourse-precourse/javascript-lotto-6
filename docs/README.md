...
- [x] 당첨번호와 각 로또의 일치 갯수 계산
- [ ] 일치 갯수를 통한 등수 및 수익금 계산
- [ ] 당첨 통계 출력

## ❗️ 예외 사항

- [x] 로또 구입 금액이 자연수가 아닌 경우
- [x] 로또 구입 금액이 1000으로 나누어 떨어지지 않는 경우

- [x] 당첨 번호가 1~45의 자연수가 아닌 경우
- [x] 당첨 번호가 6개보다 작거나 클 경우
- [x] 당첨 번호들 중 중복이 있는 경우

- [x] 보너스 번호가 1~45의 자연수가 아닌 경우
