...
콘솔 창에서 진행할 수 있는 간단한 로또 게임입니다.
안내에 따라 구매 금액과 당첨 번호, 보너스 번호를 입력하면, 당첨 결과와 수익률을 보여줍니다.

## 로또 게임은 어떻게 할 수 있나요?

1. 구매 금액을 입력하면 금액만큼의 로또가 발행됩니다.
   발행된 로또는 화면 상에 출력되기 때문에 번호를 확인하실 수 있습니다.

2. 당첨 번호와 보너스 번호를 입력하면 당첨 결과와 수익률을 확인할 수 있습니다.

3. 잘못된 값을 입력하면 다시 입력하라는 에러 메시지가 뜰 수 있습니다.
   이러한 경우 안내에 따라 값을 다시 입력해주시면 됩니다.
