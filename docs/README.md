...
- [x] 당첨통계 정리하기
  ...
  - [x] 5등부터 1등까지 일치하는 숫자 갯수,상금을 정리한다
  - [x] 앞서 생성한 로또들을 순회하며 등수를 매긴다

- [x] 당첨내역 출력하기

  - [x] 5등부터 1등까지 순서대로 `"일치갯수"개 일치 ("상금"원) "당첨된 로또 갯수"개` 이렇게 출력한다

- [x] 총 수익률 구하기
  - [x] 총 수익을 구매금액으로 나눠서 수익률을 계산한다(총 수익액 / 총 구입금액)\*100
  - [x] 수익률을 소수점 둘째자리에서 반올림한다
  - [] 수익률을 1000단위마다 ,로 끊어준다
- [x] 총 수익률 출력하기
