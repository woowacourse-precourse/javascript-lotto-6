...
describe('WinningLotto 클래스 테스트', () => {
  ...
  test('올바른 당첨 번호 배열과 보너스 번호를 전달하면 WinningLotto 인스턴스가 생성된다', () => {
    const winningLotto = new WinningLotto(winningNums, '7');
