...
class LottoBudget {
    ...
    GET_LOTTO_BUDGET_INPUT_MESSEGE="구입금액을 입력해 주세요.\n";
    ...
    #isValid(lottoBudget){
        ...
        this.LOTTO_NUMBER = lottoBudget/this.LOTTO_PRICE;
    ...
    async getInput() {
        this.lottoBudget = parseInt(await Console.readLineAsync(this.GET_LOTTO_BUDGET_INPUT_MESSEGE));
