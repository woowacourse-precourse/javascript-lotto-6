...
class LottoViewer {
  ...
  static winningResult(result) {
    ...
    Console.print(`${MESSAGE.WINNING_STATISTICS}
      ...
      ${MATCH_COUNT.FIVE}${MESSAGE.MATCH}${MESSAGE.BONUS_MATCH} (${Formatter.numberFormat.format(LOTTO_PRIZE_AMOUNT.SECOND_PLACE)}${MESSAGE.WON}) - ${result.secondPrize}${MESSAGE.PIECES}
