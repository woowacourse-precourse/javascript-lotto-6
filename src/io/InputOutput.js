...
const lottoOutput = {
  ...
  printResultRate(rate) {
    Console.print(
      `${GAME_MESSAGE.RESULT_RATE} ${rate}${GAME_MESSAGE.RESULT_SUFFIX}`
    );
  },
  printLine() {
    Console.print('');
...
const printWinnings = [
  function printThreeMatch(num) {
    Console.print(
      `${GAME_MESSAGE.THREE_MATCH}${GAME_MESSAGE.DASH}${num}${GAME_MESSAGE.NUMBER_SUFFIX}`
    );
  },
  function printFourMatch(num) {
    Console.print(
      `${GAME_MESSAGE.FOUR_MATCH}${GAME_MESSAGE.DASH}${num}${GAME_MESSAGE.NUMBER_SUFFIX}`
    );
  },
  function printFiveMatch(num) {
    Console.print(
      `${GAME_MESSAGE.FIVE_MATCH}${GAME_MESSAGE.DASH}${num}${GAME_MESSAGE.NUMBER_SUFFIX}`
    );
  },
  function printFiveWithBonus(num) {
    Console.print(
      `${GAME_MESSAGE.FIVE_MATCH_WITH_BONUS}${GAME_MESSAGE.DASH}${num}${GAME_MESSAGE.NUMBER_SUFFIX}`
    );
  },
  function printSixMatch(num) {
    Console.print(
      `${GAME_MESSAGE.SIX_MATCH}${GAME_MESSAGE.DASH}${num}${GAME_MESSAGE.NUMBER_SUFFIX}`
    );
  },
];
