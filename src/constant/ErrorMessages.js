...
export const ERROR_MESSAGES = Object.freeze({
  ...
  invalid_purchase_amount_unit: `${prefix} 구입 금액은 ${OPT.price}원 단위로 입력되어야 합니다.`,

  // 당첨 번호 예외
  invalid_winning_numbers_length: `${prefix} 당첨 번호는 ${OPT.lotto_number_count}개의 숫자를 입력해야 합니다.`,
  invalid_winning_numbers_format: `${prefix} 당첨 번호는 숫자여야 합니다.`,
  invalid_winning_numbers_integer: `${prefix} 당첨 번호는 정수여야 합니다.`,
  invalid_winning_numbers_range: `${prefix} 당첨 번호는 ${OPT.min_number}부터 ${OPT.max_number} 사이의 숫자여야 합니다.`,
  ...
  invalid_bonus_number_range: `${prefix} 보너스 번호는 ${OPT.min_number}부터 ${OPT.max_number} 사이의 숫자여야 합니다.`,
