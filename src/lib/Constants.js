export const GAME_RULE = Object.freeze({
  // ticekt
  LOTTO_PRICE: 1000,
  MIN_LOTTO_MONEY_INCLUSIVE: 1000,
  MAX_LOTTO_MONEY_INCLUSIVE: Number.MAX_SAFE_INTEGER,
...
export const ERROR_MESSAGE = Object.freeze({
  ...
  INVALID_MONEY_MOD: `${ERROR_HEAD} 금액은 ${GAME_RULE.LOTTO_PRICE} 단위로 입력해주세요.`,
  INVALID_MONEY_RANGE: `${ERROR_HEAD} 금액은 ${GAME_RULE.MIN_LOTTO_MONEY_INCLUSIVE}부터 ${GAME_RULE.MAX_LOTTO_MONEY_INCLUSIVE}까지 입력 가능합니다.`,
