export const ERROR_INVALID_NUMBER = "[ERROR] 구매 금액은 유효한 숫자여야 합니다.";
export const ERROR_NOT_IN_1000_UNITS = "[ERROR] 구매 금액은 1,000원 단위이어야 합니다.";
export const ERROR_INVALID_LOTTO_NUMBER_COUNT = "[ERROR] 로또 번호는 6개여야 합니다.";
export const ERROR_DUPLICATE_LOTTO_NUMBERS = "[ERROR] 로또 번호는 중복되지 않은 숫자로 이루어져야 합니다.";
...
export const PRIZE_5_MATCH_WITH_BONUS = "5개 일치, 보너스 볼 일치 (30,000,000원) - ";
