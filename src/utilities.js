...
import { RANGE_MIN, RANGE_MAX, LOTTO_LENGTH, keys, errorMessages } from './constants.js'
...
export const validatePurchase = (input) => {
    ...
    if (amount < 0)
        throw new Error(errorMessages.NEGATIVE_AMOUNT);
    if (remainder)
        throw new Error(errorMessages.PURCHASE_AMOUNT);
};
