const ERROR = Object.freeze({
  ...
  LOTTO_NUMBER: '로또 번호는 양의 정수만 가능합니다.',
  LOTTO_RANGE: "로또 번호는 '1부터 45까지'의 숫자만 가능합니다.",
  LOTTO_LENGTH: '로또 번호는 6가지의 숫자가 필요합니다.',
  LOTTO_DUPLICATE: '로또 번호는 서로 다른 6가지의 숫자만 가능합니다.',

  WINNING_NUMBER: "당첨 번호는 '양의 정수'만 입력해주셔야 합니다.",
  WINNING_RANGE: "당첨 번호는 '1부터 45까지'의 숫자만 입력해주셔야 합니다.",
  WINNING_LENGTH:
