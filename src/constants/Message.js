...
export const PURCHASE_AMOUNT_ERROR_MESSAGE = Object.freeze({
  wrongFormat: '[ERROR] 잘못된 입력입니다. 1,000원 단위로 입력해야합니다. 다시 입력해 주세요.',
  underThousand: '[ERROR] 잘못된 입력입니다. 1,000원 미만의 금액은 입력이 불가합니다. 다시 입력해 주세요.',
  notNumber: '[ERROR] 잘못된 입력입니다. 구입 금액은 숫자여야 합니다. 다시 입력해 주세요.',
});
