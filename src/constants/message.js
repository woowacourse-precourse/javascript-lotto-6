...
export const ERROR_MESSAGE = {
  ...
  invalidAmountNotDevideBy1000: '[ERROR] 구매 금액은 1,000원으로 나누어 떨어져야 합니다',
  ...
  invalidBonusNumRange: '[ERROR] 보너스 번호는 1부터 45 사이의 숫자여야 합니다.',
  invalidBonusNumDuplicate: '[ERROR] 보너스 번호는 당첨 번호와 중복되지 않아야 합니다.',
}