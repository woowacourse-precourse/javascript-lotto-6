...
class GameController {
  ...
  async start() {
    ...
    const PURCHASE_LOTTOS_MESSAGE =
      this.gameMessageGenerator.getLottoNumberListMessage(PURCHASE_LOTTOS);
    // 발급 받은 로또 번호 출력하기
    this.outputView.showLottoNumberListOutput(LOTTO_TRY_COUNT, PURCHASE_LOTTOS_MESSAGE);
    // 당첨 번호 유저인풋 얻기
