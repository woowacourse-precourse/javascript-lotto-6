...
import { ERRMSG_MONEY_NOT_MONEY, ERRMSG_MONEY_NOT_DIVIDED_BY_LOTTO_PRICE } from "../constants/ErrorMessage.js";
...
export const isDividedByLottoPrice = (money) => {
    if(money % LOTTO_PRICE !== 0) throw new Error(ERRMSG_MONEY_NOT_DIVIDED_BY_LOTTO_PRICE);
}