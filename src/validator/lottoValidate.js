...
import { ERRMSG_LOTTO_NOT_VALID_LOTTO_LENGTH, ERRMSG_LOTTO_NOT_MADE_WITH_UNIQUE_NUMBER } from "../constants/ErrorMessage.js"

export const isValidLottoLength = (length) => {
    if(length !== LOTTO_LENGTH) throw new Error(ERRMSG_LOTTO_NOT_VALID_LOTTO_LENGTH);
}
...
export const isMadeWithUniqueNumber = (numbers, bonusNumber = undefined) => {
    ...
    if(uniquenessChecker.size !== neededLength) throw new Error(ERRMSG_LOTTO_NOT_MADE_WITH_UNIQUE_NUMBER);
}