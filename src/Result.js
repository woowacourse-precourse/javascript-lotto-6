...
class Result {
  ...
  printResult() {
    Console.print(`\n당첨 통계\n---`);
    Console.print(`3개 일치 (5,000원) - ${this.state.fifth.hit}개`);
    Console.print(`4개 일치 (50,000원) - ${this.state.fourth.hit}개`);
    Console.print(`3개 일치 (1,500,000원) - ${this.state.third.hit}개`);
    Console.print(`3개 일치 (30,000,000원) - ${this.state.second.hit}개`);
    Console.print(`3개 일치 (2,000,000,000원) - ${this.state.first.hit}개`);
  }
}
