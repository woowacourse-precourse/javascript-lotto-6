...
class Result {
  ...
  printResult() {
    ...
    Console.print(`5개 일치 (1,500,000원) - ${this.state.third.hit}개`);
    Console.print(
      `5개 일치, 보너스 볼 일치 (30,000,000원) - ${this.state.second.hit}개`,
    );
    Console.print(`6개 일치 (2,000,000,000원) - ${this.state.first.hit}개`);
  }
}
