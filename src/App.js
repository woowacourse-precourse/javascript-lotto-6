import { countResults, getValidPurchaseAmount, getWinningNumbersAndBonus, printStatistics, purchaseLottos } from "./lottoUtils.js";
...
class App {
  ...
  async play() {
    ...
    this.statistics = countResults(this.lottos, this.winningResult.winningNums, this.winningResult.bonusNum, this.statistics);
