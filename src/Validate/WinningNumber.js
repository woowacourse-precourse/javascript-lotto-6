...
function validateWinningNumberSix(WINNING_NUMBER_ARRAY) {
  if (WINNING_NUMBER_ARRAY.length !== 6) {
    throw new Error(ERROR_MESSAGES.WINNING_NUMBER_NOT_SIX);
  }
}
function validateWinningNumberDuplication(WINNING_NUMBER_ARRAY) {
...
function validateWinningNumberOutOfBounds(WINNING_NUMBER_ARRAY) {
