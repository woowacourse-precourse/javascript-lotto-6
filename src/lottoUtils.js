...
export function printStatistics(purchaseAmount, statistics) {
  const roundedProfitPercentage = (statistics.totalPrice /purchaseAmount * 100).toFixed(1);
  ...
  Console.print(`${CONSTANTS.PRIZE_5_MATCH_WITH_BONUS}${statistics.second_prize}개`);
