...
export const PLZ_PURCHASE_AMOUNT = '구입금액을 입력해 주세요.';
...
export const ERROR_PURCHASE_AMOUNT_UNIT = '[ERROR] 로또 구입 금액은 1,000원 단위입니다.';
export const ERROR_PURCHASE_AMOUNT_PRICE = '[ERROR] 로또 1장의 가격은 1,000원부터 입니다.';
export const ERROR_PURCHASE_AMOUNT_STRING = '[ERROR] 로또 구입 금액은 숫자여야 합니다.';
